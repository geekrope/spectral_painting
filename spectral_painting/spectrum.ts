...
let start = 0;
let cnvs: CanvasRenderingContext2D | null = null;

window.onload = () =>
{
	const audio = document.getElementById("aud") as HTMLAudioElement;
	const src = document.getElementById("aud_src") as HTMLInputElement;
	analyser.maxDecibels = 0;
	analyser.connect(ctx.destination);
	cnvs = (document.getElementById("cnvs") as HTMLCanvasElement).getContext("2d");
